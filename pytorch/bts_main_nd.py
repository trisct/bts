...
def main_worker(gpu, ngpus_per_node, args):
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            loss_nd = current_coef * 5 * mse_criterion(nd_est[~invd_bmask], nd_gt[~invd_bmask])
            loss_diff = current_coef * 1e2 * mse_criterion(diff_gt[~invd_bmask], diff_est[~invd_bmask])
