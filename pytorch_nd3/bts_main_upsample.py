...
parser.add_argument('--debug', action='store_true', help='outputs debug information')
...
def main():
    ...
    if args.checkpoint_path == '':
        ...
        command = 'cp bts_upsample.py ' + model_out_path
        os.system(command)
        aux_out_path = args.log_directory + '/' + args.model_name + '/.'
        command = 'cp bts_main_upsample.py ' + aux_out_path
        os.system(command)
